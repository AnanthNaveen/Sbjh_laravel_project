...
<body>
    ...
    <div class="report-container">
        ...
        <div class="report-header">
            <h1 class="report-title"> {{ \Illuminate\Support\Str::title(str_replace('_', ' ', $recordata->type)) }}
                Report</h1>
        </div>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>Date of Evaluation:</strong> {{ $recordata->created_at->format('d-m-Y h:i A') }}
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    @php
                        $templates = [
                            ...
                            'Aggravating_factors_None' =>
                                'with no significant aggravating factors, except <b>:value</b>',
                            ...
                            'Past_Medical_History_None' =>
                                'has no significant past medical history, except <b>:value</b>',
                            ...
                            'Shoulder_Peripheral_Nerve_TOS_If_No' =>
                                'if TOS test is not normal, findings include <b>:value</b>',
                ...
                @elseif($recordata->type === 'spinal_deformity')
                    @php
                        $templates_spinal_deformity = [
                            ...
                            'Physiotherapy' => 'has undergone physiotherapy: <b>:value</b>',
                            'Past_Medical_History' => 'past medical history includes <b>:value</b>',
                            'Past_Medical_History_Description' =>
                                'details regarding past medical history: <b>:value</b>',
                            'Past_Surgical_History' => 'past surgical history includes <b>:value</b>',
                            'Past_Surgical_History_Description' =>
                                'details regarding past surgical history: <b>:value</b>',
                            ...
                            'High_Thoracic_prominence' =>
                                'forward bend test revealed high thoracic prominence on the <b>:value</b> side',
                            'Thoracic_prominence' =>
                                'forward bend test revealed thoracic prominence on the <b>:value</b> side',
                            'TL_prominence' =>
                                'forward bend test revealed thoracolumbar prominence on the <b>:value</b> side',
                            'Lumbar_prominence' =>
                                'forward bend test revealed lumbar prominence on the <b>:value</b> side',
                            'ROM' => 'range of motion was <b>:value</b>',
                        ...
                        foreach ($contents as $field => $value) {
                            if (isset($templates_spinal_deformity[$field])) {
                                $sentence = str_replace(
                                    ':value',
                                    str_replace('_', ' ', strtolower($value)),
                                    $templates_spinal_deformity[$field],
                                );
                                $sentences[] = $sentence;
                            }
                        }
                ...
                @elseif($recordata->type === 'shoulder_elbow')
                    ...
                    @php
                        $templates_shoulder_elbow = [
                            ...
                            'Patient_had_Similiar_complaint_in_the_Past' =>
                                'with a history of similar complaints in the past being <b>:value</b>',
                            ...
                            'Test_for_Infraspinatus_&_Teres_Minor' =>
                                'Test for infraspinatus and teres minor shows <b>:value</b>',
                            ...
                            'Three_Point_Relation_Ship' =>
                                'three point relationship of the elbow appears <b>:value</b>',
                            ...
                            'Test_for_Lateral_Epicondylitis' =>
                                'test for lateral epicondylitis demonstrates <b>:value</b>',
                        ...
                        foreach ($contents as $field => $value) {
                            if (isset($templates_shoulder_elbow[$field])) {
                                $sentence = str_replace(
                                    ':value',
                                    str_replace('_', ' ', strtolower($value)),
                                    $templates_shoulder_elbow[$field],
                                );
                                $sentences[] = $sentence;
                            }
                        }
                    ...
                    @if ($title === 'Regional Examination' && $recordata->type == 'hand_wrist')
                        @php
                            ...
                            if (!empty($sentences)) {
                                if (count($sentences) > 1) {
                                    $text =
                                        implode(', ', array_slice($sentences, 0, -1)) . ', ' . end($sentences) . '.';
                                } elseif (count($sentences) === 1) {
                                    $text = $sentences[0] . '.';
                                }
                                if (!preg_match('/^the patient/i', $text)) {
                        ...
                        @endif  --}}
                            <div class="hand-images" style="text-align: center; display:none;">
                                <img src="{{ asset('Image/hand.jpg') }}" alt="Hand Image"
